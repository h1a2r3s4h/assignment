...
export default function RefundPolicyPage() {
  const [value, setValue] = useState("<p>Refund Policy.</p>");
  ...
  return (
    <div className="space-y-5">
        ...
        <CardContent className="p-5">
          ...
          <div className="mb-5">
            ...
            <p className="mt-2 text-base text-muted-foreground">
              Update your company's Refund Policy page content.
            </p>
          </div>
      ...
      {/* Quill Styling */}
      <style jsx global>{`
        .refund-editor .ql-toolbar {
          border: 0;
          border-bottom: 1px solid #e5e7eb;
          padding: 12px;
        }

        .refund-editor .ql-container {
          border: 0;
          min-height: 220px;
        }

        .refund-editor .ql-editor {
          min-height: 220px;
          padding: 16px;
          font-size: 15px;
        }
