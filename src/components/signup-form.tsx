...
const [confirmPassword, setConfirmPassword] = useState("");
          ...
          <CardContent className="grid p-0 md:grid-cols-2">
            ...
            <div className="p-6 md:p-8">
              <div className="flex flex-col items-center gap-2 text-center">
                <div className="h-7 w-[200px] bg-gray-300" />
                <div className="h-4 w-[260px] bg-gray-300" />
              </div>
              ...
              <div className="mt-6 space-y-6">
                ...
                <div>
                  ...
                  <div className="mt-2 h-3 w-[220px] bg-gray-300" />
                </div>
                ...
                <div>
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      <div className="h-4 w-[80px] bg-gray-300 mb-2" />
                      <div className="h-11 w-full bg-gray-300 rounded-md" />
                    </div>
                    <div>
                      <div className="h-4 w-[120px] bg-gray-300 mb-2" />
                      <div className="h-11 w-full bg-gray-300 rounded-md" />
                    </div>
                  </div>
                  <div className="mt-2 h-3 w-[180px] bg-gray-300" />
                </div>
                ...
                {/* FOOT TEXT */}
                <div className="h-4 w-[220px] mx-auto bg-gray-300" />
              </div>
            </div>
  ...
  onSubmit={async (e) => {
    ...
    try {
      ...
      if (res.ok) {
  router.push(`/otp-verify?email=${email}&type=signup`);
}else {
